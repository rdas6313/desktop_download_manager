...
public class ErrorListHandler extends Observable implements DbHandler{

    private DbConnector dbConnector;
    private final String TABLE_NAME = DbConfig.ERROR_TABLE_NAME;
    
    public ErrorListHandler(DbConnector dbConnector) {
